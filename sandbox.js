...
const questions = [
    ...
    {
        title : 'Which of the following are the components of a Central Processing Unit (CPU) ?',
        options : [
    ...
    {
        title : 'Which among the following, the first generation of computers had ?',
        options : [
...
function init() {
    document.body.innerHTML = `
        <h1 class="quiz-heading">Quizhut</h1>
        <h3 class="slogan">Put your knowledge to the test!!!</h3>
        <div class="app-body">
